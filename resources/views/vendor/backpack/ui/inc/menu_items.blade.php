...
<x-backpack::menu-item title="Asystenci" icon="la la-question" :link="backpack_url('assistant')" />
...
<x-backpack::menu-item title="Declarations" icon="la la-question" :link="backpack_url('declaration')" />
